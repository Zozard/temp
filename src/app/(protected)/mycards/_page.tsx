...
//   const [editSelection, setEditSelection] = useState(new Set<string>());
...
//     const cardToSellPromise = updateToSell(
//       selectedCard.card_id,
//       user!.email,
//       quantityToSell
//     );
//     const cardToBuyPromise = updateToBuy(
//       selectedCard.card_id,
//       user!.email,
//       quantityToBuy
//     );
...
//     if (editSelection.has(card.card_id)) {
//       const updatedSelection = new Set([...editSelection].filter(x => x !== card.card_id))
//       setEditSelection(updatedSelection);
//       return
//     }

//     const updatedSelection = new Set([...editSelection, card.card_id]);
//     setEditSelection(updatedSelection);
//   };
// */
...
//           onClick={() => setCardFilter(false)}
//         >
//           All cards
//         </button>
//         <button
//           className="toggle-button-cardSet"
//           onClick={() => setCardFilter(true)}
//         >
//           My Cards
//         </button>
//         <button
...
//               <input type="checkbox" checked={editSelection.has(card.card_id)} />
//             </div>
//           </div>
//         ))}
//       </div>
